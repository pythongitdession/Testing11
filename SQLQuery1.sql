...
INSERT INTO EMP_DTS_SRC1 VALUES ('7','DAL','SAM','N',9000,'1993-12-02','female','2021-04-09');

INSERT INTO EMP_DTS_SRC2 VALUES ('1','BRYYANT','WILL','Z',900,'1993-12-02','F','2018-04-09');
INSERT INTO EMP_DTS_SRC2 VALUES ('2','CURRAN','KATE','B',5000,'1978-12-02','f','2001-04-09');
INSERT INTO EMP_DTS_SRC2 VALUES ('3','ROSS','EMMA','H',8000,'1993-12-02','M','2018-04-09');
    
INSERT INTO EMP_DTS_SRC3 VALUES ('1','ROSS','ALEX','F',700,'1978-12-02','1','1999-04-09');    
INSERT INTO EMP_DTS_SRC3 VALUES ('2','ROSS','ALEX','F',7000,'1978-12-02','1','1999-04-09');
...
--Covert Source table's data which is expected in target table and compare both.--null condition does not concate
...
Select EMP_CODE, EMP_NAME as EMP_NAME_TRG  from EMP_DTS_TRG 
Where EMP_CODE = 'EMP010'
...
Update EMP_DTS_SRC1 set HIRE_DATE  = '1910-03-31'
where EMP_CODE = 'EMP01' ;


--32) To check SCD Transformation in EMP_DTS_TRG  update record To check EMP_GENDER 'Male' is converted to ‘M’ in target.
...
INSERT INTO [dbo].[EMP_DTS_SRC1] ([EMP_ID],[LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE])
     VALUES
           (1,'S','Rohit','S', '1000', '1993-11-01 00:00:00.000','Male','2017-03-31')
GO
...
Update EMP_DTS_SRC1 set EMP_GENDER  = 'Male'
where EMP_CODE = 'EMP01' ;



--33) To check SCD Transformation in EMP_DTS_TRG  update record To check EMP_GENDER 'Female' is converted to ‘F’ in target.
...
Update EMP_DTS_SRC1 set EMP_GENDER  = 'Female'
where EMP_CODE = 'EMP01' ;




Update EMP_DTS_SRC1 set EMP_GENDER  = 'Unknown'
where EMP_CODE = 'EMP01' ;
...
--36)To check SCD Transformation in EMP_DTS_TRG  update records in EMP_DOB column
...
INSERT INTO [dbo].[EMP_DTS_SRC1] ([EMP_ID],[LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE])
     VALUES
           (1,'S','Rohit','S', '1000', '1994-11-01 00:00:00.000','Male','2017-03-31')
GO
...
Update EMP_DTS_SRC1 set EMP_DOB  = '2001-11-04'
where EMP_CODE = 'EMP01' ;


--37) To check SCD Transformation in EMP_DTS_TRG  update records in HIRE_DATE column
...
Update EMP_DTS_SRC1 set HIRE_DATE  = '2001-03-04'
where EMP_CODE = 'EMP01' ;
...
select COUNT(*) as COUNT_OF_EMP_DTS_TRG from EMP_DTS_TRG
Where REFERENCE_TABLE = 'EMP_DTS_SRC2' ; 

--3)To validate Null count between 'EMP_DTS_SRC2 and  EMP_DTS_TRG.
...
--7)Verify Direct mapping of 'EMP_DTS_SRC2' of 'EMP_CODE','EMP_DOB','EMP_GENDER','EMP_DATE' columns between 'EMP_DTS_SRC2' and 'EMP_DTS_TRG' Table

Select EMP_CODE,EMP_DOB,EMP_GENDER,HIRE_DATE from EMP_DTS_SRC2
Where EMP_SALARY > = 1000 

--Except

Select EMP_CODE,EMP_DOB,EMP_GENDER,HIRE_DATE from EMP_DTS_TRG
Where REFERENCE_TABLE = 'EMP_DTS_SRC2';
...
--Covert Source table's data which is expected in target table and compare both.--null condition does not concate
Select EMP_CODE, (LAST_NAME+ ' ' +FIRST_NAME+ ' ' + ISNULL (MIDDLE_NAME, ''))EMP_NAME from EMP_DTS_SRC2
Where EMP_SALARY > = 1000
...
--Covert Source table's data which is expected in target table and compare both.
Select EMP_CODE,(LAST_NAME+ ' ' +FIRST_NAME+ ' ' + ISNULL (MIDDLE_NAME, ''))EMP_NAME from EMP_DTS_SRC2
Where EMP_CODE = 'EMP010' AND EMP_SALARY > = 1000

--Except

Select EMP_CODE, EMP_NAME from EMP_DTS_TRG 
Where EMP_CODE = 'EMP010'
AND REFERENCE_TABLE = 'EMP_DTS_SRC2'; 
...
INSERT INTO [dbo].[EMP_DTS_SRC2] ([EMP_ID],[LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE])
     VALUES
           (1,'D','Rohit','S', '1000', '1993-11-01 00:00:00.000','M','1920-03-31')
GO
...
Update EMP_DTS_SRC2 set FIRST_NAME  = 'Rahul'
where EMP_CODE = 'E001' ;


----Update MIddle name in source table

Update EMP_DTS_SRC2 set LAST_NAME  = 'B'
where EMP_CODE = 'E001' ;

----Update MIddle name in source table

Update EMP_DTS_SRC2 set MIDDLE_NAME  = 'Y'
where EMP_CODE = 'E001' ;


----Update middle name 'null' in source table

Update EMP_DTS_SRC2 set MIDDLE_NAME  = NULL
where EMP_CODE = 'E001' ;
...
INSERT INTO [dbo].[EMP_DTS_SRC2] ([EMP_ID],[LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE])
     VALUES
           (1,'D','Rohit','S', '1000', '1993-11-01 00:00:00.000','M','2017-03-31')
GO
...
Update EMP_DTS_SRC2 set EMP_SALARY  = 989
where EMP_CODE = 'E001' ;
...
Update EMP_DTS_SRC2 set EMP_SALARY  = 1001
where EMP_CODE = 'E001' ;
...
Update EMP_DTS_SRC2 set EMP_SALARY  = 1000
where EMP_CODE = 'E001' ;
...
Update EMP_DTS_SRC2 set HIRE_DATE  = '2021-03-31'
where EMP_CODE = 'E001' ;


----Update salary in source table

Update EMP_DTS_SRC2 set HIRE_DATE  = '2022-03-31'
where EMP_CODE = 'E001' ;
...
Update EMP_DTS_SRC2 set HIRE_DATE  = '1920-03-31'
where EMP_CODE = 'E001' ;


--33) To check SCD Transformation in EMP_DTS_TRG  update record To check EMP_GENDER 'Male' is converted to ‘M’ in target.
...
INSERT INTO [dbo].[EMP_DTS_SRC2] ([EMP_ID],[LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE])
     VALUES
           (1,'S','Rohit','S', '1000', '1993-11-01 00:00:00.000','M','2017-03-31')
GO
...
Update EMP_DTS_SRC2 set EMP_GENDER  = 'M'
where EMP_CODE = 'E001' ;


--34) To check SCD Transformation in EMP_DTS_TRG  update record To check EMP_GENDER 'Female' is converted to ‘F’ in target.

Update EMP_DTS_SRC2 set EMP_GENDER  = 'Female'
where EMP_CODE = 'E001' ;
...
INSERT INTO [dbo].[EMP_DTS_SRC2] ([EMP_ID],[LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE])
     VALUES
           (1,'S','Rohit','S', '1000', '1994-11-01 00:00:00.000','M','2017-03-31')
GO
...
Update EMP_DTS_SRC2 set EMP_DOB  = '2001-11-04'
where EMP_CODE = 'E001' ;
...
Update EMP_DTS_SRC2 set HIRE_DATE  = '2001-03-04'
where EMP_CODE = 'E001' ;
...
select COUNT(*) as COUNT_OF_EMP_DTS_TRG from EMP_DTS_TRG
Where REFERENCE_TABLE = 'EMP_DTS_SRC3' ; 
...
Select EMP_CODE,EMP_DOB,HIRE_DATE,EMP_GENDER from EMP_DTS_SRC3
Where EMP_SALARY > = 1000 

--Except

Select EMP_CODE,EMP_DOB,HIRE_DATE,EMP_GENDER from EMP_DTS_TRG
Where REFERENCE_TABLE = 'EMP_DTS_SRC3';
...
--Covert Source table's data which is expected in target table and compare both.
Select EMP_CODE, (LAST_NAME+ ' ' +FIRST_NAME+ ' ' + ISNULL (MIDDLE_NAME, ''))EMP_NAME from EMP_DTS_SRC3
Where EMP_SALARY > = 1000 --and EMP_CODE = 'EMP07'

--Except

Select EMP_CODE, EMP_NAME from EMP_DTS_TRG 
Where REFERENCE_TABLE = 'EMP_DTS_SRC3' --and EMP_CODE = 'EMP07' ; 
...
(Case when EMP_GENDER = '1' Then 'Male'
	 When EMP_GENDER = '2' Then 'Female'
...
INSERT INTO [dbo].[EMP_DTS_SRC3] ([EMP_ID],[LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE])
     VALUES
           (1,'D','Rohit','S', '1000', '1993-11-01 00:00:00.000','1','1920-03-31')
GO
...
Update EMP_DTS_SRC3 set FIRST_NAME  = 'Rahul'
where EMP_CODE = 'ID11' ;


----Update MIddle name in source table

Update EMP_DTS_SRC3 set LAST_NAME  = 'B'
where EMP_CODE = 'ID11' ;


----Update MIddle name in source table

Update EMP_DTS_SRC3 set MIDDLE_NAME  = ''
where EMP_CODE = 'ID11' ;


----Update middle name 'null' in source table

Update EMP_DTS_SRC3 set MIDDLE_NAME  = NULL
where EMP_CODE = 'ID11' ;
...
INSERT INTO [dbo].[EMP_DTS_SRC3] ([EMP_ID],[LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE])
     VALUES
           (1,'D','Rohit','S', '1000', '1993-11-01 00:00:00.000','1','2017-03-31')
GO
...
Update EMP_DTS_SRC3 set EMP_SALARY  = 1001
where EMP_CODE = 'ID11' ;
...
Update EMP_DTS_SRC3 set EMP_SALARY  = 1000
where EMP_CODE = 'ID11' ;
...
Update EMP_DTS_SRC3 set HIRE_DATE  = '2021-03-31'
where EMP_CODE = 'ID11' ;


----Update salary in source table

Update EMP_DTS_SRC3 set HIRE_DATE  = '2022-03-31'
where EMP_CODE = 'ID11' ;
...
Update EMP_DTS_SRC3 set HIRE_DATE  = '1920-03-31'
where EMP_CODE = 'ID11' ;
...
INSERT INTO [dbo].[EMP_DTS_SRC3] ([EMP_ID],[LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE])
     VALUES
           (1,'S','Rohit','S', '1000', '1993-11-01 00:00:00.000','1','2017-03-31')
GO
...
Update EMP_DTS_SRC3 set EMP_GENDER  = '1'
where EMP_CODE = 'ID11' ;


--34) To check SCD Transformation in EMP_DTS_TRG  update record To check EMP_GENDER 'Female' is converted to ‘F’ in target.

Update EMP_DTS_SRC3 set EMP_GENDER  = '2'
where EMP_CODE = 'ID11' ;

Update EMP_DTS_SRC3 set EMP_GENDER  = 'Unknown'
where EMP_CODE = 'ID11' ;
...
INSERT INTO [dbo].[EMP_DTS_SRC3] ([EMP_ID],[LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE])
     VALUES
           (1,'S','Rohit','S', '1000', '1994-11-01 00:00:00.000','1','2017-03-31')
GO
...
Update EMP_DTS_SRC3 set EMP_DOB  = '2001-11-04'
where EMP_CODE = 'ID11' ;
...
Update EMP_DTS_SRC3 set HIRE_DATE  = '2001-03-04'
where EMP_CODE = 'ID11' ;
